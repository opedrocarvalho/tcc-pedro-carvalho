...
\begin{enumerate}
    ...
    O \textbf{Hadoop Distributed File System (HDFS)} é citado como o componente fundamental \acs{open_source} para a construção de um \textit{Data Lake}, permitindo o armazenamento confiável e o processamento distribuído de grandes conjuntos de dados \cite{murarka2024, septian2019}.
