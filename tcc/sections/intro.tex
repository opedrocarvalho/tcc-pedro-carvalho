...
Diante desse cenário e dos problemas descritos, surge a questão de pesquisa deste trabalho: \textbf{Como ferramentas \textit{open source} podem ser utilizadas na construção de \textit{pipelines} de dados eficientes, escaláveis e acessíveis, e quais são seus impactos em comparação com soluções proprietárias?} 
